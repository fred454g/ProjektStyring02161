Feature: Fjern medarbejder fra aktivitet
    ...
    Som en medarbejder
    Vil jeg kunne fjerne en medarbejder fra en aktivitet på et projekt

    Background: Grunddata for fjernelse af medarbejder fra aktivitet
    ...
    Scenario: Fejlscenarie 6 - Medarbejderen er ikke tilknyttet aktiviteten
        Given at medarbejderen "huba" er tilknyttet aktiviteten "Backend API" på projekt "26001"
        And at medarbejderen "jfk" er tilknyttet projekt "26001"
        When medarbejderen fjerner "jfk" fra aktiviteten "Backend API" på projekt "26001"
        Then giver systemet fejlmeddelelsen "Medarbejder er ikke i aktivitet"

    Scenario: Succescenarie - Fjern medarbejder fra aktivitet
