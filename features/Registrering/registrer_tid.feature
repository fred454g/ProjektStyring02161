Feature: Registrer tid (dagligt)
    ...
    Background: Grunddata for registrering af tid
    ...
    Scenario: Sccesscenarie 1 - Medarbejder kan registrere tid uden direkte aktivitetstilknytning
        When medarbejderen registrerer 2.0 timer på aktiviteten "Frontend" på projekt "26001" for dags dato
    ...
    Scenario: Sccesscenarie 2 - Tidsregistrering med halvtimes nøjagtighed
    ...
    Scenario: Sccesscenarie 3 - Flere tidsregistreringer på samme aktivitet akkumuleres
        When medarbejderen registrerer 2.0 timer på aktiviteten "Frontend" på projekt "26001" for dags dato
        Then giver systenet ingen fejlmeddelelse
    ...
    Scenario: Sccesscenarie 4 - Daglig tidsregistrering
        When medarbejderen registrerer 4.5 timer på aktiviteten "Frontend" på projekt "26001" for dags dato
        Then giver systenet ingen fejlmeddelelse
